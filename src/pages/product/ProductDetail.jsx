          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="h-30 w-18  bg-gray-100 mb-6 py-4 px-4">
                  <div className="flex mb-3">
                    <span className="text-xl text-black-800 ">Included in the price:</span>
                  </div>
                  <ul>
                    <li className="flex items-center ml-4 mb-1">
                      <span className="text-green"><FaCheck /></span>
